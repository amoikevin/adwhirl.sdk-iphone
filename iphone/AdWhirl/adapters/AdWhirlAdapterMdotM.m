...
- (void)getAd {
	...
	if ([adWhirlDelegate respondsToSelector:@selector(facebookuserid)] ) {
		NSString* facebookuserid = [adWhirlDelegate facebookuserid];
		[userContextDic setObject:facebookuserid forKey:@"facebookuserid"];
	}
	...
	NSLog(@"Requesting MdotM ad (%@) %@", str, adRequestURL);
